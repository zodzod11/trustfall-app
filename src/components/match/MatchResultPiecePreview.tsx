    ...
    return (
      <div className="fixed inset-0 z-[60] flex flex-col bg-background">
        ...
        <div className="tf-no-scrollbar flex-1 overflow-y-auto px-4 pb-28 pt-4 sm:px-5">
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl bg-surface-elevated">
            <img
              src={pieceFromRank.imageUrl}
              alt={pieceFromRank.serviceTitle}
              className="h-full w-full object-cover"
            />
          </div>
          <div className="mt-6 space-y-2">
            <h1 className="text-xl font-semibold tracking-tight text-foreground">
              {pieceFromRank.serviceTitle}
            </h1>
            <p className="text-xs font-semibold uppercase tracking-wider text-accent">
              {pieceFromRank.scoreLabel}
            </p>
          </div>
        </div>
